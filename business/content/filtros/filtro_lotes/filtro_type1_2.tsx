...
export default function Filtro({ rtl, rtl2, rangePrice, isClick, lotes, applyFilter, setListUpdate}: any) {
    ...
    const [values2, setValues2] = React.useState([300, 500]);

    const [list, setList] = React.useState(lotes);
    ...
    return (
        <>
            ...
            <div className={styles.general}>
                ...
                <p hidden={true}><strong>{t('filter.areaText')}</strong></p>
